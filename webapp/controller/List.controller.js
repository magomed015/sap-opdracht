sap.ui.define([
    ...
    return BaseController.extend("be.ap.edu.zsd048game.controller.List", {
        ...
        _showDetail: function (oItem) {
            ...
            this.getOwnerComponent().PlatformKey = oItem.getBindingContext("json").getModel().getProperty(`${oItem.getBindingContextPath()}`);
