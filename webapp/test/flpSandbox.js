		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#beapeduzsd048game-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beapeduzsd048game-display": {
								"semanticObject": "beapeduzsd048game",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.ap.edu.zsd048game",
									"url": sap.ui.require.toUrl("be/ap/edu/zsd048game")
								}
							}
						}
					}
